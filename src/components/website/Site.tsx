...
export default function Site({initial,catalog}:{initial:WebsiteContent;catalog:SiteCatalog}) {
  ...
  return <div style={style} className={c.identity.rounded?'editable-site rounded-site':'editable-site'}>
    ...
    <main>
      ...
      <Booking chosenService={chosenService} title={c.booking.title} intro={c.booking.intro.replace('Te contactaremos para confirmar tu turno.', 'Tu turno queda confirmado al reservar.')} preview={preview}/>
